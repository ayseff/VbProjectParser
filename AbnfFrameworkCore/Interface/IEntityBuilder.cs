...
namespace AbnfFrameworkCore.Interface
{
        ...
        where T : class
    {
        ...
        IPropertyBuilder<T, IEnumerable<TProperty>> EnumerableProperty<TProperty>(Expression<Func<T, IEnumerable<TProperty>>> PropertySelector, int? MinCount = null, int? MaxCount = null);
    }
}
