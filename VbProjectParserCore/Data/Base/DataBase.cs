...
public abstract class DataBase
{
    ...
    protected virtual void AutoReadMembers(XlBinaryReader Reader)
    {
        ...
        var autoReadMembers = 
            type.GetMembers()
            .Where(mi => Attribute.IsDefined(mi, typeof(AutoReadAttribute)))
            .OrderBy(mi => mi.GetCustomAttribute<AutoReadAttribute>().Order);
    ...
    protected virtual void ValidateArraySize<T>(string ParamName, ref T[] array, uint ExpectedSize)
    {
